...
- **Market allocation lever** (`da_commit_fraction`): the share of the battery's power the Day-Ahead auction may commit — the rest is held back for the intraday stage, free to chase MID without first unwinding a DA position (and paying slippage on the unwind). The allocation-frontier sweep in notebook 03 measures what the optimal DA/intraday split *would have been*
