...
DEFAULT_GENERATION_ACTUAL_SOURCE = os.environ.get(
    "DEFAULT_GENERATION_ACTUAL_SOURCE", "ELEXON"
)  # "ELEXON" | "CSV"
DEFAULT_DAY_AHEAD_PRICE_SOURCE = os.environ.get(
    "DEFAULT_DAY_AHEAD_PRICE_SOURCE", "ENTSOE"
)  # "ENTSOE" | "CSV"
DEFAULT_MARKET_INDEX_SOURCE = os.environ.get(
    "DEFAULT_MARKET_INDEX_SOURCE", "ELEXON"
)  # "ELEXON" | "CSV"
DEFAULT_DEMAND_ACTUAL_SOURCE = os.environ.get(
    "DEFAULT_DEMAND_ACTUAL_SOURCE", "ELEXON"
)  # "ELEXON" | "CSV"
DEFAULT_IMBALANCE_PRICE_SOURCE = os.environ.get(
