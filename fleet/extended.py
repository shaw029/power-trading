"""The live dashboard's battery population — generated, do not hand-edit.
...
65 sites / 99 BM Units / 5,559 MW, against the curated registry's
23 / 47 / 2,761 MW. Every registry site is included —
...
* For the 23 curated sites, ``optimiser``, ``region`` and
...
Generated 2026-08-29 from census snapshot by ``scripts/build_extended_fleet.py``.
